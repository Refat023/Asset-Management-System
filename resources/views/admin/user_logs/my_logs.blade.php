...
<div class="container-fluid">
    <div class="page-header">
        <h2><i class="fa fa-user-circle"></i> My Login History</h2>
        <p class="mb-0">Monitor your login activity</p>
    </div>
    ...
    <div class="filter-section">
        <form method="GET" action="{{ route('user.logs.my') }}" class="form-inline">
            <div class="row w-100">
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                    ...
                    <div>
                        ...
                        <a href="{{ route('user.logs.my') }}" class="btn btn-outline-secondary btn-sm">
